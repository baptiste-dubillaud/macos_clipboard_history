...
///
/// **Tout est capturé, y compris les contenus marqués sensibles** (`ConcealedType`
/// & co. des gestionnaires de mots de passe). Décision produit : l'historique est
/// purement local, et la base sera protégée par identifiants. Le seul contrôle de
/// confidentialité est la pause manuelle (`ClipboardStore.isCapturePaused`).
@MainActor
